...
if __name__ == "__main__": 
    ...
    gui.title("A Calculator with tkinter") 
    ...
    equation.set('designed by alaran') 
	...
	#contact = Button(gui, text 'contact',fg='black', bg='green', 
#    
#    			  command=lambda:show('linkedin.com/alaran.ibrahim'),height=1,width=14)
#    contact.grid(row=6,column=1)
    ...
    Contact= Button(gui, text='contact', fg='black', bg='green', 
                    ...
                    command=lambda: press('WHTSP=+2347065774110'), height=1, width=7) 

    Contact.grid(row=6, column=1) 
    
    Thank_you= Button(gui, text='Thank you', fg='black', bg='green', 

                    command=lambda: press('Gracias'), height=1, width=7) 

    Thank_you.grid(row=6, column=2) 
